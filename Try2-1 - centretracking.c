...
float S=10; //standard speed
float P=0; //preset error
...
/////////////////////////////MOVING THE BOT/////////////////////////////
	...
	if(PID>=150 && lr>=0){left();velocity(output,output);}
	else if(PID<=-150 && lr<0){right();velocity(output,output);}
	else if(PID<=-10 && lr>0){soft_right();velocity(output,output);}
	else if(PID>=10 && lr<0){soft_left();velocity(output,output);}
	else {forward();velocity(output,output);}
